      ...
      <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container my-12">
          ...
          <div className="flex flex-1 flex-col text-justify mx-10 sm:mx-20 md:mx-10 leading-7">
            ...
            <p className="mt-4 lg:max-w-lg">
              Mosota Abunga & Associates Advocates, LLP is a boutique law firm
              specializing in commercial, property and dispute resolution law,
              including other areas of law outlined in our Areas of Practice.
              Our team is comprised of highly qualified and experienced lawyers,
              whose focus is to deliver high quality, risk conscious and cost
            ...
            <p className="mt-6 lg:max-w-lg">
              In relation to any matter mentioned in our Areas of Practice,
              Mosota Abunga & Associates Advocates, LLP has the expertise, experience
              and resources to deliver a highly professional and competent legal
              service.
            </p>
